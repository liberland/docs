...
![Use dApp - 1](../../.gitbook/assets/use-dapp-1.png)
...
*   Confirm, and the page should load
    ...
    ![Use dApp - 2](../../.gitbook/assets/use-dapp-2.png)
...
![Opening network settings guide - 1](../../.gitbook/assets/add-network-1.png)

* From the home screen, tap the menu icon in top-left corner
* Tap `Manage Networks`
* Tap `+` icon in the top-right corner

![Opening network settings guide - 2](../../.gitbook/assets/add-network-2.png)
