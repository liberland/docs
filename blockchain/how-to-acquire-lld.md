...
To buy LLD with a credit card or bank transfer, use [Coinstore](https://h5.coinstore.com/h5/signup?invitCode=IgwIq8). Coinstore is a centralized exchange that allows you to buy crypto for fiat and supports LLD.
