...
* _DO NOT_ expose your validators RPC ports (9933 and 9944 by default) publicly on the internet. Treat validators with more care than full nodes.
* You _do not_ need to a run a validator to earn LLD staking rewards. As a user you can simply become a nominator and stake your coins without needing to run a validator.
...
* If something went wrong and you need to get session keys manually, see [Regenerating session keys](https://github.com/liberland/docs/blob/master/blockchain/for-validators-nominators-and-stakers/regenerate_session_keys.md).
...
See [Using prebuilt binary](https://github.com/liberland/docs/blob/master/blockchain/for-validators-nominators-and-stakers/using_prebuilt_binary.md)

### Option 4: using source

See [Using source](https://github.com/liberland/docs/blob/master/blockchain/for-validators-nominators-and-stakers/using_source.md)
